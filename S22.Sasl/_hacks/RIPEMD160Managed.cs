...
namespace S22.Sasl
{
        ...
        : RIPEMD160
    {
        ...
        public RIPEMD160Managed()
        {
            ...
            // if (CryptoConfig.AllowOnlyFipsAlgorithms && AppContextSwitches.UseLegacyFipsThrow) throw new InvalidOperationException("Cryptography_NonCompliantFIPSAlgorithm");
        ...
        public override void Initialize()
        {
            ...
            System.Array.Clear(_blockDWords, 0, _blockDWords.Length);
            ...
            fixed (uint* stateMD160 = _stateMD160)
            {
                fixed (byte* buffer = _buffer)
                {
                    fixed (uint* blockDWords = _blockDWords)
                    {
                        ...
                        {
                            System.Buffer.BlockCopy(partIn, partInBase, _buffer, bufferLen, 64 - bufferLen);
                        ...
                        while (partInLen >= 64)
                        {
                            System.Buffer.BlockCopy(partIn, partInBase, _buffer, 0, 64);
                            partInBase += 64;
                            partInLen -= 64;
                            MDTransform(blockDWords, stateMD160, buffer);
                        }
                        ...
                        if (partInLen > 0)
                        {
                            System.Buffer.BlockCopy(partIn, partInBase, _buffer, bufferLen, partInLen);
                        }
                    }
                }
            }
