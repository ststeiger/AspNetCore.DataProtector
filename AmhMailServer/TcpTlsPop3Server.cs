...
namespace AmhMailServer
{
    ...
    public class Pop3UpgradableTlsSession
        : NetCoreServer.UpgradableTlsSession
    {
        ...
        public Pop3UpgradableTlsSession(NetCoreServer.UpgradableTlsServer server)
            : base(server)
        {
    ...
    } // End Class Pop3UpgradableTlsSession 


    // https://stackoverflow.com/questions/16809214/is-smtp-based-on-tcp-or-udp
    public class TlsUpgradablePop3Server
        : NetCoreServer.UpgradableTlsServer
    {

        public TlsUpgradablePop3Server(NetCoreServer.SslContext context, System.Net.IPAddress address, int port)
            :base(context, address, port) 
        { }


        protected override NetCoreServer.UpgradableTlsSession CreateSession()
        {
            return new Pop3UpgradableTlsSession(this);
        ...
        public static void Test()
        {
            ...
            TlsUpgradablePop3Server server = new TlsUpgradablePop3Server(context, System.Net.IPAddress.Any, port);
