...
namespace NetCoreServer
{
    ...
    public class UpgradableTlsServer 
        : IDisposable
    {
        /// <summary>
        ...
        public UpgradableTlsServer(SslContext context, IPAddress address, int port) 
        ...
        /// <param name="address">IP address</param>
        /// <param name="port">Port number</param>
        public UpgradableTlsServer(SslContext context, string address, int port) 
        ...
        public UpgradableTlsServer(SslContext context, IPEndPoint endpoint)
        {
            Id = Guid.NewGuid();
            Context = context;
            Endpoint = endpoint;
        ...
        protected virtual UpgradableTlsSession CreateSession() { return new UpgradableTlsSession(this); }
        ...
        // Server sessions
        protected readonly ConcurrentDictionary<Guid, UpgradableTlsSession> Sessions = new ConcurrentDictionary<Guid, UpgradableTlsSession>();
        ...
        public UpgradableTlsSession FindSession(Guid id)
        {
            // Try to find the required session
            return Sessions.TryGetValue(id, out UpgradableTlsSession result) ? result : null;
        }
        ...
        internal void RegisterSession(UpgradableTlsSession session)
        {
            // Register a new session
        ...
        {
            // Unregister session by Id
            Sessions.TryRemove(id, out UpgradableTlsSession temp);
        }
        ...
        protected virtual void OnConnected(UpgradableTlsSession session) {}
        /// <summary>
        /// Handle session handshaked notification
        /// </summary>
        /// <param name="session">Handshaked session</param>
        protected virtual void OnHandshaked(UpgradableTlsSession session) {}
        /// <summary>
        /// Handle session disconnected notification
        /// </summary>
        /// <param name="session">Disconnected session</param>
        protected virtual void OnDisconnected(UpgradableTlsSession session) {}
        ...
        internal void OnConnectedInternal(UpgradableTlsSession session) { OnConnected(session); }
        internal void OnHandshakedInternal(UpgradableTlsSession session) { OnHandshaked(session); }
        internal void OnDisconnectedInternal(UpgradableTlsSession session) { OnDisconnected(session); }
